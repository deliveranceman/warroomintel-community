...
function FieldOpsPage() {
  ...
  if (view === 'list') return (
    <div style={{ minHeight: '100vh', background: BG, color: TXT, display: 'flex', flexDirection: 'column' as const }}>
      <Breadcrumb />
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px 80px', width: '100%', boxSizing: 'border-box' as const }}>
  ...
  if (view === 'new-case') return (
    <div style={{ minHeight: '100vh', background: BG, color: TXT, display: 'flex', flexDirection: 'column' as const }}>
      <Breadcrumb />
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 24px 80px', width: '100%', boxSizing: 'border-box' as const }}>
